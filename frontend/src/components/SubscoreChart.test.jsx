...
test("defaults missing subscores to 0 and shows no note markers", () => {
...
test("shows a tooltip with the value and note on hover, and hides it on mouse leave", () => {
  ...
  expect(growthRow.querySelector(".subscore-tooltip")).toHaveTextContent("Approximate trend note");

  fireEvent.mouseLeave(growthRow);
  expect(growthRow.querySelector(".subscore-tooltip")).not.toBeInTheDocument();
});
